                  ...
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          ...
                          <p class="info-box-subtitle"><a href="tel:(+256) 752-736-930">(+256) 752-736-930</a></p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          ...
                          <p class="info-box-subtitle"><a href="mailto:info@erosypaints.com">info@erosypaints.com</a></p>
                      </div>
                    </div>
                  </li>
                  <li class="last">
          ...
          <div id="team-slide" class="team-slide">
              <div class="item">
                <div class="ts-team-wrapper">
                    ...
                    <div class="ts-team-content">
                      <h3 class="ts-name">Micheal Nkiriye</h3>
                      <p class="ts-designation">Co-founder Erosy paints</p>
                      <p class="ts-description">Strategy officer</p>
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    ...
                    <div class="ts-team-content">
                      <h3 class="ts-name">Steven Walusimbi</h3>
                      <p class="ts-designation">Director</p>
                      <p class="ts-description">Director</p>
                      <div class="team-social-icons">
                          <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    ...
                    <div class="ts-team-content">
                      <h3 class="ts-name">Marvin Sendikaddiwa</h3>
                      <p class="ts-designation">Head Digital Marketing</p>
                      <p class="ts-description">Head of digital marketing which includes:- Branding, social media influencer</p>
                      <div class="team-social-icons">
                          <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                          <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
                          <a target="_blank" href="#"><i class="fab fa-linkedin"></i></a>
